...
#### SSL / HTTPS IS ENABLED HERE ( A+ rating )			                	#########
#### Check your certificates/key files and dhparam file					#########
#### Create a new dhparam using the following command as root/sudo inside /etc/nginx/ssl#########
#### openssl dhparam -out dhparam.pem 2048 ( 4096 is possible but might take long )	######### 
#### Caching is ENABLED ! 				                        	#########
#### Wordpress ready and friendly, permalinks ok		                	#########
#### Created by : marcipribeiro87 - Marcio Passos Ribeiro 	                	#########
#### Date : 20-04-2017 Version: 0.3 e-mail: marciopribeiro87@gmail.com          	#########
